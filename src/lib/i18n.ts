...
const TR: Dict = {
  ...
  sorumlulukReddi: '⚠️ Bu uygulama yalnızca bilgilendirme ve farkındalık amaçlıdır. Sunulan veriler bilimsel kaynaklardan derlenen istatistiksel tahminlerdir; resmi zemin raporu, mühendislik teminatı veya yasal geçerliliği yoktur. Kesin bilgi için uzman görüşü alınız.',
  yerli: '🇹🇷 Yerli',
...
const EN: Dict = {
  ...
  sorumlulukReddi: '⚠️ This application is for informational and awareness purposes only. The data presented is based on statistical estimates derived from scientific sources and does not constitute an official ground report, engineering guarantee, or legal document. Please consult a qualified expert for definitive assessments.',
  yerli: '🇹🇷 Local',
