export type LangKey =
  | 'appName' | 'appSubtitle'
  | 'navBolgeAnalizi' | 'navAilePlani' | 'nav72hCanta' | 'navHarita' | 'navYakinda'
...
const TR: Dict = {
  ...
  metricDepremSayisi: 'Kayıtlı deprem',
  ...
  haritaTurkiye: 'Türkiye (Son 30 Gün)',
  haritaDunya: 'Dünya (M6.5+, Son 30 Gün)',
...
const EN: Dict = {
  ...
  metricDepremSayisi: 'Recorded quakes',
  ...
  haritaTurkiye: 'Turkey (Last 30 Days)',
  haritaDunya: 'World (M6.5+, Last 30 Days)',
